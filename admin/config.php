<?php
// HTTP
define('HTTP_SERVER', 'http://192.168.0.22/shop/admin/');
define('HTTP_CATALOG', 'http://192.168.0.22/shop/');

// HTTPS
define('HTTPS_SERVER', 'http://192.168.0.22/shop/admin/');
define('HTTPS_CATALOG', 'http://192.168.0.22/shop/');
...
define('DB_HOSTNAME', '192.168.0.22');
