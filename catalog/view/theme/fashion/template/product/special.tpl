...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="white-bg top-blk"><h2><?php echo $heading_title; ?></h2>
      <?php if ($products) { ?>
      ...
      <div class="row">
        ...
        <div class="product-layout product-list col-xs-12">
          <div class="product-thumb white-bg">
      ...
      <hr>
              ...
              <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i><?php /* <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span> */ ?></button>
